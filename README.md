...
[Docs](https://docs.openclaw.ai) · [Getting Started](https://docs.openclaw.ai/start/getting-started) · [Updating](https://docs.openclaw.ai/install/updating) · [FAQ](https://docs.openclaw.ai/start/faq) · [Wizard](https://docs.openclaw.ai/start/wizard)
...
## Private fork profile

This fork is maintained for private, local operation.

- Focuses on day-to-day assistant runtime (gateway, CLI, and selected integrations).
- Removes public OSS/community surfaces where they do not add private operational value.
- Keeps docs and setup guidance practical and stable instead of release/community oriented.
- Treats this repository as operator-owned infrastructure, not a public distribution channel.
...
This README is intentionally tuned for a private, operator-owned fork.
If features are removed or added, keep this file focused on operational intent
instead of file-level inventory.
